...
* **[Mission Center](https://github.com/Slimbook-Team/mission-center):** The core hardware metrics parsing logic in our `gatherer` subsystem is adapted from Mission Center's process and usage gathering tools under the GPL license. 
